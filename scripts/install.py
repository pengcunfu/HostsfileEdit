"""
Author: pengcunfu
Repository: https://github.com/pengcunfu/python-scripts
Version: 1.0
Description: 将编译后的Hosts文件编辑工具安装到本地系统，创建快捷方式并配置环境
...
使用方法: python scripts/install.py
"""
import shutil
import sys
import subprocess
...
# 安装目标目录（程序将被直接复制到此目录）
INSTALL_BASE_DIR = "D:\\Tools\\HostsFileEdit"

# 可执行文件名
EXE_NAME = "HostsFileEdit.exe"

# 快捷方式名称（不含 .lnk 后缀）
SHORTCUT_NAME = "HostsFileEdit"
